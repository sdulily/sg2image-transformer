...
class MASK_GPT(nn.Module):
    ...
    def __init__(self, vocab_size, block_size, n_layer=12, n_head=8, n_embd=256,
        ...
        self.condition_token_size=5000
        self.tok_emb = nn.Embedding(config.vocab_size+self.condition_token_size, config.n_embd)
